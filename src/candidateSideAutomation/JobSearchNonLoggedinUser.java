...
public class JobSearchNonLoggedinUser extends candidateBaseFunctions{
	...
	/////////////Search with Skill,Location & Experience from Logout Page/////////////////
	
	@Test(priority=2)
	public void SearchWithAllLogout() throws InterruptedException
	{
	int count = x.getRowCount("Deep_SearchSkillLoc&Exp");
	int i=0;
	for (int j=2;j<=count;j++)
...
/////////////Search with Skill,Location & Experience from SRP Page/////////////////
		...
		for (int j=2;j<=count;j++)
		{	
		driver.get("http://www.timesjobs.com/candidate/mysearch-result.html?searchType=personalizedSearch&from=submit&txtKeywords=java&txtLocation=");
		Thread.sleep(5000);
